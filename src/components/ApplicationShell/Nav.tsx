...
export const Nav = () => {
  ...
  transition-colors"
    ...
    transition-colors"
      ...
      <a
        href="https://futuretrading-umair.netlify.app/"
        target="_blanck"
        className="px-6 py-3 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold shadow-xl hover:scale-105 hover:shadow-2xl hover:from-purple-500 hover:to-indigo-500 transition-all duration-300 ease-in-out"
        style={{ display: "flex", justifyContent: "center" }}
      >
        <button> 🚀 Start Mock Trade</button>
      </a>
    </nav>
  );
};
